  ...
  (t = function () {
    ...
    function w(e) {
      ...
      if (A(e) || g(e)) (r = e), (t = S(e)), (n = L(e));
        ...
        var o = e.name;
        if (((r = o), B.call(e, "weight") && (i = e.weight) <= 0)) throw new Error(D(o));
            ...
            (function e(t, i, u) {
              if (E(t))
                if (i[u]) {
                  var o = t[i[u]];
                  if (!E(o)) return;
                  if (u === i.length - 1 && (A(o) || m(o) || C(o))) n.push(p(o));
                  else if (g(o)) {
                    r = !0;
                    for (var c = 0, a = o.length; c < a; c += 1) e(o[c], i, u + 1);
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                this.keys.forEach(function (t, i) {
                  ...
                  if (E(u))
                    if (g(u)) {
                      for (var o = [], c = [{ nestedArrIndex: -1, value: u }]; c.length; ) {
                        var a = c.pop(),
                          s = a.nestedArrIndex,
                          h = a.value;
                        if (E(h))
    ...
    function P(e, t, n) {
      ...
      if (t.length > N) throw new Error("Pattern length exceeds max of ".concat(N, "."));
      for (
        var A,
          m = t.length,
          C = e.length,
        ...
        var D = R(t, { currentLocation: A, expectedLocation: k, distance: c, ignoreLocation: p });
        if (((E = Math.min(D, E)), (F = A + m), M))
          for (var B = 0; B < m; ) (b[A + B] = 1), (B += 1);
      }
      F = -1;
      for (var x = [], w = 1, S = m + C, L = 1 << (m - 1), _ = 0; _ < m; _ += 1) {
        for (var j = 0, I = S; j < I; )
          R(t, {
            errors: _,
            currentLocation: k + I,
      ...
      if (M) {
        var J = (function () {
          for (
            ...
            c && -1 === r
              ? (r = u)
              : c || -1 === r || ((i = u - 1) - r + 1 >= t && n.push([r, i]), (r = -1));
          }
          ...
          u(e, [
            {
              ...
              value: function (e) {
                var t = this.options,
                  ...
                  i = t.includeMatches;
                if (((e = n ? e : e.toLowerCase()), (e = r ? z(e) : e), this.pattern === e)) {
                ...
                this.chunks.forEach(function (t) {
                  var n = t.pattern,
                    ...
                    A = o.score,
                    m = o.indices;
                  p && (y = !0), (g += A), p && m && (v = [].concat(f(v), f(m)));
                });
            ...
            [
              {
                ...
                value: function (e) {
                  ...
                  for (var o = 0, c = [], a = 0, s = 0, h = t.length; s < h; s += 1) {
                    var l = t[s];
                    (c.length = 0), (o = 0);
                  ...
                  e.forEach(function (e) {
                    ...
                    e.matches.forEach(function (e) {
                      var n = e.key,
                        ...
                        u = e.score,
                        o = n ? n.weight : null;
                      t *= Math.pow(0 === u && o ? Number.EPSILON : u, (o || 1) * (r ? 1 : i));
                    }),
                      (e.score = t);
                  });
                })(s, { ignoreFieldNorm: a }),
              ...
              var t = this,
                ...
                r = function e(n, r, i) {
                  if (!n.children) {
                    ...
                    return c && c.length ? [{ idx: i, item: r, matches: c }] : [];
                  }
                  for (var a = [], s = 0, h = n.children.length; s < h; s += 1) {
              ...
              return (
                i.forEach(function (e) {
                  ...
                  if (E(t)) {
                    var c = r(n, t, i);
                    c.length &&
                      (u[i] || ((u[i] = { idx: i, item: t, matches: [] }), o.push(u[i])),
                ...
                u.forEach(function (e) {
                  ...
                  if (E(r)) {
                    ...
                    i.forEach(function (e, i) {
                      c.push.apply(c, f(t._findMatches({ key: e, value: r[i], searcher: n })));
                    }),
                ...
                n.forEach(function (e) {
                  ...
                  if (E(n)) {
                    var c = r.searchIn(n),
                      ...
                      s = c.score,
                      h = c.indices;
                    a && i.push({ score: s, key: t, value: n, idx: u, norm: o, indices: h });
                  }
                });
              else {
                var u = n.v,
                  ...
                  s = c.score,
                  h = c.indices;
                a && i.push({ score: s, key: t, value: u, norm: o, indices: h });
              }
              return i;
            },
          },
