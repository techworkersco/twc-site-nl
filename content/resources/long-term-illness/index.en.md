...
| --- | --- | --- |
| *Arbo-arts* | Occupational health physician | The term '*arbo-arts*' is sometimes mistakenly used to refer to a *bedrijfsarts* (company doctor). An *arbo-arts* isn't a company doctor, but a health care professional that can work under the supervision of a company doctor. Occupational health physicians aren't allowed to perform independent medical assessments. |
...
| *Bedrijfsarts* | Company doctor | A health care professional paid by the employer who evaluates a worker's -- their patient's -- abilities to perform their regular duties, and reports that evaluation back to the company in conjunction with the patient. In theory, a company doctor's focus should be on their patient's health. A company doctor is obliged to keep your medical information private, and not share it with the company that pays for their services. Company doctors are chosen by the company and, if there's a works council, the company's works council. |
...
| *Huisarts* | General Practitioner (GP) <br/> Home doctor | A healthcare professional who's often the first point of contact when someone's ill and requires medical support. A GP can be involved in diagnosing and treating medical conditions, as well as referring to specialists for further support and treatment -- this can include physical (such as orthopedic) and mental (such as therapy) treatments. GPs must keep their patient's medical information private, though they can share it with specialists with the patient's consent. In the Netherlands people can choose their own GP. |
| Illness | Sickness, sick | Anything that prevents someone from performing their regular duties |
| Illness period | | A period of time that spans from the first day that someone's declared ill to their last day of illness. An illness period can include multiple different illnesses, for example burnout and a broken leg. |
| Illness period, first day of | | <p>The first day that the employee was unable to perform their regular duties. ([Burgerlijk Wetboek 7:629 lid 1](http://wetten.overheid.nl/jci1.3:c:BWBR0005290&amp;boek=7&amp;titeldeel=10&amp;afdeling=2&amp;artikel=629&amp;lid=1)) <br/> ℹ️ <b>Note:</b> Illness during vacation should be transferred to sick leave, and as such the first day of illness might be whilst someone is on vacation.</p> |
| Illness period, last day of | | The day at which an employee who has registered sick has worked at 100% of their regular duties for 4 weeks without interruption. ([Burgerlijk Wetboek 7:629 lid 10](http://wetten.overheid.nl/jci1.3:c:BWBR0005290&amp;boek=7&amp;titeldeel=10&amp;afdeling=2&amp;artikel=629&amp;lid=10)) |
...
| Occupational impairment | *Arbeidsongeschikt* | You have an occupational impairment if the prognosis of an illness is likely to result in a permanent reduction in a person's ability to perform 100% of their regular duties. In other words: illness without full recovery. Occupational impairment is usually measured in a percentage of the person's ability to perform their regular duties. |
| <a href="https://www.uwv.nl/nl/ziek/loondoorbetaling/plan-van-aanpak">Plan of action</a> | *Plan van aktie* | The plan agreed upon between you and your employer about your trajectory of reintegration. Basic principles: <ul><li>Work tasks should remain relevant to your original job description, unless you agree otherwise. For example, you can't be required to mop floors if that wasn't part of your job.</li><li>Your employer can't force you to undergo additional treatments, therapies, guidance or counseling</li></ul> Some employers can be pushy for dates about when you'll return to work. The reality is that health doesn't work that way. Take the plan of action one step at a time, and revise when needed.
...
| *Verzekeringarts* | Insurance doctor | This doctor works at the UWV and is responsible for evaluating how to patient has been handled during the long-term illness trajectory. |
| WIA benefit | *WIA-uitkering*, from *[Wet werk en inkomen naar arbeidsvermogen](https://wetten.overheid.nl/BWBR0019057/2026-01-01)*<br/> Sickness benefit | The WIA benefit is specifically for people who can't work due to occupational impairment. When a person is declared as occupationally impaired, they generally receive a portion (or all) of their future income from the WIA benefit. This benefit is paid from collective provisions, instead of through the employer. |
...
<!-- Check: Employer is listed as participant in weeks 86-93 but it's not stated what they do -->
<!-- Check weeks 86-93: Must your medical info be shared with UWV? -->
<!-- Check: Employer is listed as participant in week 93, what do they do? -->

| Timeline | Description | Responsibility of |
| --- | --- | --- |
| <b>From week 8</b>, continued every 6 weeks at a minimum</br> Evaluation meetings | Meetings to evaluate how your reintegration is going in light of the plan of action continue. The content of the discussions may change though in year 2. If it's unlikely that you'll return to your role, then alternatives (such as [eerste spoor](#eerste-spoor-first-track) or [tweede spoor](#tweede-spoor-second-track)) may be discussed and your plan of action might get adjusted. | Employee + Employer |
...
| <b>By week 93</b> </br> Apply for WIA benefit | If you're unlikely to reintegrate, and if you're applying for WIA benefit, then you must now submit the end evaluation and accompanying documents to the UWV. In exceptional cases, the UWV can extend this deadline if you're on a reintegration trajectory and are very likely to reintegrate before the end of the 2 year period | Employee + Employer |
...
Your company doctor, GP, and any specialists you might be seeing are all heathcare providers. In theory, they should all have your well-being and recovery at heart. (But note that the company doctor is paid by your employer.) 

However, only the company doctor's advice forms the direct input to your reintegration plan, which ultimately you and your employer should agree upon. You can choose to provide your company doctor with any relevant information from your GP or specialist doctor, so that the company doctor can take this into account in formulating their advice. (You aren't obliged to share this medical information, but you can if it's helpful.)
